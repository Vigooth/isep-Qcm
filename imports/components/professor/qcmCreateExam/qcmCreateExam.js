...
import template from './qcmCreateExam.html'
...
export default angular.module('qcmCreateExam', [

    angularMeteor,angularMeteor,angularBootstrap

])
    .component('qcmCreateExam',{
        templateUrl:template,
        controller:['$scope','$stateParams',QcmCreateExamCtrl]
    })
